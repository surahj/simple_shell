...
/**
 * help_all - Displays all possible builtin shell_lex commands.
 */
void help_all(void)
{
...
/**
 * help_alias - Displays information on the shell_lex builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Displays information on the shell_lex builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the shell_lex builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on the shell_lex builtin command 'help'.
 */
void help_help(void)
{
	char *msg = "help: help\n\tSee all possible shell_lex builtin commands.\n";
